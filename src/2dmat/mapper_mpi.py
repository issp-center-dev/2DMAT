...
def main():
    ...
    parser.add_argument('--dimension', type=int, default=2, help='(default: %(default)s)')
    parser.add_argument('--llist', type=str, nargs='*', default=["z1(Si)", "z2(Si)"], help='(default: %(default)s)')
    parser.add_argument('--slist', type=str, nargs='*', default=["value_01", "value_02"], help='(default: %(default)s)')
    parser.add_argument('--sinput', type=str, default='surf.txt', help='(default: %(default)s)')
    parser.add_argument('--boutput', type=str, default='bulkP.b', help='(default: %(default)s)')
    parser.add_argument('--soutput', type=str, default='surf-bulkP.s', help='(default: %(default)s)')
    parser.add_argument('--norm', type=str, default='TOTAL', choices=['TOTAL', 'MAX'], help='(default: %(default)s)')
    parser.add_argument('--rfactor', type=str, default='A', choices=['A', 'B'], help='(default: %(default)s)')
    ...
    parser.add_argument('--dmax', type=float, default=6.0, help='(default: %(default)s)')
    parser.add_argument('--rnumber', type=int, default=8, help='(default: %(default)s)')
    parser.add_argument('--omega', type=float, default=0.5, help='(default: %(default)s)')
...
if rank == 0:
    ...
    for i in range(pieces):
        ...
        for item in ["bulk.exe", "surf.exe", "bulk.txt", "template.txt", "experiment.txt"]:
            shutil.copy(item,"%s/%s"%(sub_folder_name, item))
        shutil.copy("devided_MeshData%08d.txt"%(i), "%s/MeshData.txt"%(sub_folder_name))
